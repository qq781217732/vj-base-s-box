...
public partial class WeaponVjM16a1 : WeaponVjBase
{
    [Property] public string PrintName = "M4A1";
    ...
    [Property] public string ViewModel = "models/weapons/cstrike/c_rif_m4a1.mdl";
    [Property] public string WorldModel = "models/vj_base/weapons/w_m4a1_s.mdl";
    [Property] public bool WorldModel_UseCustomPosition = true;
    [Property] public Vector3 WorldModel_CustomPositionAngle = Vector(0, 90, 180);
    [Property] public Vector3 WorldModel_CustomPositionOrigin = Vector(-3.4, -1, 0);
