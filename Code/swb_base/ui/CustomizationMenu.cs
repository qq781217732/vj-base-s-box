...
public class CustomizationMenu : Panel
{
	...
	void CreateCategoryPanels()
	{
		foreach ( var entry in attachmentsPerCategory )
		{
			...
			var iconWrapperImg = iconWrapperP.AddChild<Image>();
			iconWrapperImg.AddClass( "icon" );
	...
	void CreateAttachmentPanels( AttachmentCategory category )
	{
		...
		attachments.ForEach( attachment =>
		{
			...
			var attachIconImg = iconWrapperP.AddChild<Image>();
				attachIconImg.SetTexture( attachment.IconPath );
				attachIconImg.AddClass( "icon" );
