...
public partial class Weapon
{
	...
	/// <summary>Blocks entering ADS while reloading</summary>
	[Property, Group( "Aiming" ), Feature( "Core" )] public bool AdsBlockWhileReloading { get; set; } = true;

	/// <summary>Blocks entering ADS while customizing</summary>
	[Property, Group( "Aiming" ), Feature( "Core" )] public bool AdsBlockWhileCustomizing { get; set; } = true;

	/// <summary>Blocks entering ADS while running</summary>
	[Property, Group( "Aiming" ), Feature( "Core" )] public bool AdsBlockWhileRunning { get; set; } = false;

	/// <summary>Blocks entering ADS while sliding</summary>
	[Property, Group( "Aiming" ), Feature( "Core" )] public bool AdsBlockWhileSliding { get; set; } = false;

	/// <summary>Cancel ADS when reloading starts</summary>
	[Property, Group( "Aiming" ), Feature( "Core" )] public bool AdsCancelOnReloadStart { get; set; } = true;

	/// <summary>Cancel ADS when sprint starts</summary>
	[Property, Group( "Aiming" ), Feature( "Core" )] public bool AdsCancelOnSprintStart { get; set; } = true;

	/// <summary>Cancel ADS when sliding starts</summary>
	[Property, Group( "Aiming" ), Feature( "Core" )] public bool AdsCancelOnSlideStart { get; set; } = false;
	...
	public bool IsRunning => Owner.IsRunning && !Owner.IsSliding && Owner.IsOnGround && Owner.Velocity.Length >= 200;
	...
	bool suppressAimUntilInputReleased = false;
