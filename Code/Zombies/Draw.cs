...
namespace Sandbox.Debug
{
	public struct Draw
	{
		public static Draw Once => new Draw( Time.Delta * 1.5f, Color.White, true );
		...
		{
			//DebugOverlay.Line( startPos, endPos, Color, Duration, DepthTest ); // TODO: DebugOverlay is internal in new API
		}
	}
}
