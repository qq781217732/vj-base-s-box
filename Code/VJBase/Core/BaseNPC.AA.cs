...
public partial class BaseNPC
{
	...
	public virtual void AA_MoveTo(object dest, bool playAnim = true, string moveType = "Calm", Dictionary<string, object> extraOptions = null)
	{
		...
		if (MovementType == VJMoveType.Aquatic)
		{
			...
			// different water body separated by land (Source would detect the water exit/re-entry).
			// In practice: submerged NPC + subsequent TraceHull make this edge case unreachable.
			if (destVec != null)
			{
